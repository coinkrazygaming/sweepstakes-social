...
const PRAGMATIC_SLOTS: PragmaticSlot[] = [
  {
    ...
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs20olympgate.png",
    category: "Popular",
  ...
  },
  {
    id: "sweet-bonanza",
    name: "Sweet Bonanza",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs20fruitsw.png",
    category: "Popular",
    provider: "Pragmatic Play",
    rtp: 96.48,
    volatility: "High",
  ...
  },
  {
    id: "the-dog-house",
    name: "The Dog House",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs20doghouse.png",
    category: "Animal",
    provider: "Pragmatic Play",
    rtp: 96.51,
    volatility: "High",
  ...
  },
  {
    id: "wolf-gold",
    name: "Wolf Gold",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs25wolfgold.png",
    category: "Animal",
    provider: "Pragmatic Play",
    rtp: 96.01,
    volatility: "Medium",
  ...
  },
  {
    ...
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vswaysrhino.png",
    category: "Megaways",
    provider: "Pragmatic Play",
    rtp: 96.58,
    volatility: "High",
  ...
  },
  {
    ...
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs20starlight.png",
    category: "Fantasy",
    provider: "Pragmatic Play",
    rtp: 96.5,
    volatility: "High",
  ...
  },
  {
    ...
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs10fishing.png",
    category: "Fishing",
    provider: "Pragmatic Play",
    rtp: 96.71,
    volatility: "High",
  ...
  },
  {
    id: "sugar-rush",
    name: "Sugar Rush",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs20sugarrush.png",
    category: "Sweet",
    provider: "Pragmatic Play",
    rtp: 96.5,
    volatility: "High",
  ...
  },
  {
    id: "book-of-fallen",
    name: "Book of Fallen",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs10bookoftut.png",
    category: "Adventure",
    provider: "Pragmatic Play",
    rtp: 96.28,
    volatility: "High",
  ...
  },
  {
    id: "wild-west-gold",
    name: "Wild West Gold",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs40wildwest.png",
    category: "Western",
    provider: "Pragmatic Play",
    rtp: 96.51,
    volatility: "High",
  ...
  },
  {
    id: "fire-strike",
    name: "Fire Strike",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs15fire.png",
    category: "Classic",
    provider: "Pragmatic Play",
    rtp: 96.48,
    volatility: "High",
  ...
  },
  {
    id: "aztec-gems",
    name: "Aztec Gems",
    thumbnail: "https://demogamesfree.pragmaticplay.net/gs2c/common/images/games/200x200/vs9aztecgems.png",
    category: "Adventure",
    provider: "Pragmatic Play",
    rtp: 96.52,
    volatility: "High",
...
export const getPragmaticSlots: RequestHandler = (req, res) => {
  try {
    ...
    const categories = [...new Set(PRAGMATIC_SLOTS.map(slot => slot.category))];
...
export const getUserHistory: RequestHandler = (req, res) => {
  ...
  let userHistory = gameHistories.filter(game => 
    game.sessionId.includes(userId) || userId === 'demo-user'
  );
...
export const getAdminStats: RequestHandler = (_req, res) => {
  ...
  const todayGames = gameHistories.filter(g => g.timestamp >= today.getTime());
  
  const revenueToday = todayGames.reduce((sum, g) => sum + g.amount, 0) -
    todayGames.filter(g => g.result === 'win').reduce((sum, g) => sum + (g.winAmount || 0), 0);
  
  const thisMonth = new Date();
  thisMonth.setDate(1);
  thisMonth.setHours(0, 0, 0, 0);
  const monthGames = gameHistories.filter(g => g.timestamp >= thisMonth.getTime());
  
  const revenueMonth = monthGames.reduce((sum, g) => sum + g.amount, 0) -
    monthGames.filter(g => g.result === 'win').reduce((sum, g) => sum + (g.winAmount || 0), 0);
